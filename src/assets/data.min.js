...
const data = {
	...
	Portfolio: [
		{
			...
			description:
				"AI Image Generation is base on OpenAI. Backend server is desgined by using Flask Python. OpenAI is midjourney.ai, leonardo.ai, stability.ai and so on...",
			placement: "top",
		...
		},
		{
			...
			description:
				"AI video generation is base on Open AI, This project is used pictory.ai(video generation). In this website, I select the avatar which you want and make the advertisement video.",
			placement: "bottom",
			github: "ruiu-ai"
		},
		{
	...
	Contact: [
		...
		},
		{
			...
			links: [
				{ type: "tel:", title: "+62 822-6068-2705" },
			],
		},
		{
			animationClass: "Right",
