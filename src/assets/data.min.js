const identity = { name: "John Rashid", image: "Profile-pic" };
const data = {
	NavBar: {
		...identity,
		links: [
	...
	Home: {
		introduction:
			"I am a 2017 pass out Graduates of Bachelor of Technology in Computer Science Engineering from Tsinghua University(Beijing)",
		resumeLink: "",
		typedElement: [
			"John Rashid",
	...
	About: {
		...
		about: {
			"tech-stats":
				"Fullstack Developer, Android, Data Science, Web3 developer",
			bio: "I've been with One Realty in Las Vegas for 10 months from 2020-01 to 2021-10 as a Blockchain Developer, and from 2021-11 to 2023-05 I have been working in Owebest as a frontend developer. I 'm responsible for designing and implementing websites, ensuring high-performance and availability, and managing all technical aspects of the CMS. I have a strong understanding of front-end programming languages, a good eye for aesthetics, and strong content management skills. Additionally, I can conduct website performance tests, troubleshoot issues, and provide diagnostic reports of website performance. ",
			"IDE, Editors & Tools": [
				"Android Studio",
				"Intellij",
				"PyCharm",
		...
		skills: [
			...
			[
				...
				{ skill: "CMS development", progress: "80" },
			],
		],
		education: [
			{
				...
				college:
					"Tsinghua University (THUU) in China(Beijing)",
				duration: "2014 - 2017",
				percentage: "CGPA:9.1",
			},
			{
				...
				college: "Sekolah Menengah St. Michael",
				duration: "Year of Completion : 2014",
			...
			},
			{
				...
				duration: "SMK Pandan Indah : 2012",
	...
	Portfolio: [
		{
			...
			description:
				"AI Image Generation is a special project which uses almost every topic of data science and Machine Learning. In this project, we can upload image and bot will predict the caption of that image.",
			placement: "top",
			github: "AI-image-generate"
		},
		{
			...
			description:
				"In this project we were able to see modern cars and buy ones, and this site include pricing function.",
			placement: "top",
			github: "car-showcase"
		},
		{
			...
			project: "cryptoverse",
			description:
				"A crypto app can refer to a mobile application that allows users to manage, buy, sell, and trade cryptocurrencies. This app include features such as wallet management, trading options, and reward programs. ",
			placement: "top",
			github: "crypto-app"
		},
		{
			...
			description:
				"This system is food delivery management system base on Mern stack",
			placement: "bottom",
			github: "Food-Delivery-App"
		},
		{
			...
			project: "metaversus",
			description:
				" It is a spatial computing platform that acts as an alternative to or a replica of the real world. It is a virtual world of interconnected communities where people can meet, work, and play, using virtual reality headsets, augmented reality, and other advanced internet technologies",
			placement: "bottom",
			github: "Metaversus"
		},
		{
			...
			delay: "0.5s",
			project: "trademarktoday",
			description:
				"Created An Web Application which help us to shorten the URL by using Mongodb as Database and Bootstrap for Front end.",
			placement: "bottom",
			github: "trademarktoday"
		},
		{
			animationClass: "rotateInUpLeft",
			delay: "0.5s",
			project: "chatbot-marn",
			description:
				"Created chatbot base on MERN stack. similar to GPT3.5",
			placement: "bottom",
			github: "AI-chatbot-mern"
		},
		{
			animationClass: "slideInDown",
			delay: "0",
			project: "ofgenius",
			description:
				"This project is consist of ai-image-generator, ai-voice-cloning and voice generator, and chatbot base on MERN stack.",
			placement: "bottom",
			github: "OFGenius"
		},
		{
			...
			project: "order",
			description:
				"This project is Performance system of order management. It is base on MERN stack. This project include order management and order satistics",
			placement: "bottom",
			github: "PerfSYS_frontend"
		},
		{
			animationClass: "rotateInUpLeft",
			delay: "0.5s",
			project: "mobile-food-delivery",
			description:
				"This project is Food-dlivery APP, using by React Native",
			placement: "bottom",
			github: "mobile-food-delivery"
		},
		{
			animationClass: "slideInDown",
			delay: "0.5s",
			project: "personal-dev",
			description:
				"JEIHOON Online Book Shopping website using ASP.NET MVC. Tech Stack: ASP.NET MVC, C#, SQL, HTML, CSS, JavaScript, Bootstrap",
			placement: "bottom",
			github: "personal-development"
		},
		{
			animationClass: "slideInDown",
			delay: "0.5s",
			project: "myshopify",
			description:
				"I developed 30+ shopify or wordpress site. and I 'm expert wordpress plugin and wordpress theme and shopify plugin",
			placement: "bottom",
			github: "Wordpress-url"
		}
	],
	Training: {
			...
			[
				{
					...
					description:
						"Gained insights into blockchain's business impact, benefits, risks, obstacles, and use cases.",
					link: "1TeUHpmWZ4A9GoytTfLMnxiSvGPpZWKn7",
				},
				{
					class: "Down",
					...
					link: "1VQV5amN7myWJ9KIU83swx_YD6RkAjc_p",
				},
				{
					class: "Right",
					...
					description:
						"As I taught learners how to build interactive web applications, I focused on front-end development libraries like React and Redux.",
					link: "1rgAzYOGOOzKWQIYiFZshhofBLyUJeEXB",
				},
			],
			[
				{
					...
					link: "1TKMS8_Pr5pATGCc1jspEPuW7MzHDHOP7",
				},
				{
					class: "Up",
					...
					link: "1EfbZTcrheQSsMaNzYRxN0fy34Hv8drWB",
				},
				{
					class: "Right",
					title: "Data Science",
					...
					link: "1h8sNSXNGSpRCJTpgnP4hdirS4wIPxIYF",
				},
			],
		],
	},
	Achievement: [
		{
			animationClass: "Left",
			description:
				"122+ Web projects (2017-2022) including MERN & MEAN & CMS & Blockchain",
			image: "web",
		},
		{
	...
	Contact: [
		...
		},
		{
			...
			links: [
				{ type: "tel:", title: "+60-0341436422" },
				{ type: "tel:", title: "+60-0146741269" },
			],
		},
		{
			animationClass: "Right",
			...
			links: [{ type: "mailto:", title: "johnrashid816@gmail.com" }, { type: "mailto:", title: "Skype Address  live:.cid.ae67f840e8605c6c" },],
		},
	],
	Social: [
		[
			{
				link: "https://github.com/luckyman816",
				class: "fab fa-github",
				name: "GitHub",
				placement: "left",
			},
			{
				link: "https://www.linkedin.com/in/luckyman816",
				class: "fab fa-linkedin-in",
				name: "LinkedIn",
				placement: "top",
			},
			{
				link: "https://gist.github.com/luckyman816",
				class: "fas fa-laptop-code",
				name: "Gist",
				placement: "top",
			},
			{
				link: "https://www.hackerrank.com/luckyman816",
		...
		[
			{
				link: "https://www.instagram.com/luckyman816",
				class: "fab fa-instagram",
				name: "Instagram",
				placement: "left",
			},
			{
				link: "https://www.facebook.com/luckyman816",
			...
			{
				link: "https://twitter.com/luckyman816",
